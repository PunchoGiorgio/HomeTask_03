currency_exchange = [{"EUR": None, "UAH": 40.92, "GBP": 0.85, "CHF": 0.94, "USD": 1.08},
...
class Price:
    def __init__(self, flight_value: int=None, curr_flight: str=None, hotel_value: int=None, curr_hotel: str=None):
    ...
    def check_hotel(self):
        ...
        if self.curr_hotel not in currencies:
            ...
            return round(self.hotel_value * currency_exchange[currency_list.index(self.curr_hotel)][obj_f.curr_flight])
